module github.com/go-kivik/memorydb
...
require (
	...
	github.com/go-kivik/kiviktest v2.0.0-pre2.0.20190818172917-4d860006d15b+incompatible
	github.com/go-kivik/mango v0.0.2
